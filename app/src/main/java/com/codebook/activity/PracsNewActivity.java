...
public class PracsNewActivity extends AppCompatActivity {
    private static final String TAG = "PracsNewActivity";
...
//        }
        setContentView(R.layout.adapter_pracs);
...
//        myToolbar.setTitleTextColor(getResources().getColor(R.color.text_color));
    ...
    private void attachCategoryFragment(ArrayList<Category> categories) {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.pracsContainer, CategoryFragment.newInstance(categories))
                .commit();
    }
